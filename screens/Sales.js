...
const Sales = () => {
    ...
    useEffect(() => {
        fetch('http://fyp-nik.herokuapp.com/sales/week').then(res => res.json()).then(data => setWeekly(data)).catch(err => alert(err));
        fetch('http://fyp-nik.herokuapp.com/sales/monthly').then(res => res.json()).then(data => setMonthly(data)).catch(err => alert(err));
